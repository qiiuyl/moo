<template>
  <div class="radio inner-border">
    <div class="img-group">
      <img :src="list[0].a_img" alt/>
      <div class="big-img">
        <div class="radio-date">{{`${month}/${radioDate}`}}</div>
        <div class="mask"></div>
        <img :src="list[1].a_img" alt />
      </div>
      <img :src="list[2].a_img" alt class="right-img"/>    
    </div>
    <div class="radio-info" @click="playMusic">
      <div class="info-title">
        <p class="my-title">MOO Radio</p>
        <span class="my-small">个性好歌推荐</span>
      </div>
      <div class="play-btn">
        <img :src="is_play?'images/radio_play.png':'images/radio_paused.png'" alt="">
      </div>
    </div>
  </div>
</template>
